<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeftFrame.aspx.cs" Inherits="SVG.Frame.LeftFrame" %>
...
<body onload="initinav('基本形狀')">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function InitWindows() {
            var height2 = document.body.scrollHeight - 75 + 100;

            // alert(height);
            // document.getElementById("left").style.height=height2;
            document.getElementById("main_nav").style.height = height2 + "px";
            document.getElementById("left_main_nav").style.height = height2 + "px";
            document.getElementById("right_main_nav").style.height = height2 + "px";
            // showTime()
            setTimeout("InitWindows()", 5000);
        }
